...
turtlesRouter.put('/secondFavoritePizzaBind/:id', turtleController.bindSecondFavoritePizzaTurtle);
...
turtlesRouter.delete('/secondFavoritePizzaUnbind/:id', turtleController.unbindSecondFavoritePizzaTurtle);
